...
},{"./controllers/blog-controller":6,"./controllers/post-controller":7,"./directives/disqus-directive":8,"./directives/infinite-scroll-directive":9,"./services/cache-service":11,"./services/content-service":12,"angular":3,"angular-route":1,"angular-sanitize":2}],11:[function(require,module,exports){
module.exports = [
...
module.exports = [
  '$http', '$rootScope', 'CacheService', '$q', '$sce', '$log', function($http, $rootScope, CacheService, $q, $sce, $log) {
            ...
            return _this.getPage(page).then(function(posts) {
              ...
              if (typeof post === 'undefined') {
                ...
                return $http.get("content/" + post.filename, {
                  ...
                  return _.extend(post, {
                    html: $sce.trustAsHtml(fullText.data)
                  });
                });
              }
            });
